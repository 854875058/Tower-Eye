...
class Settings(BaseSettings):
    ...
    # Data workbench
    WORKBENCH_STORAGE_DIR: str = "./data/workbench"
    WORKBENCH_TASK_WORKERS: int = 1
    WORKBENCH_CHUNK_SIZE: int = 1200
    WORKBENCH_CHUNK_OVERLAP: int = 150
    WORKBENCH_SFTP_TIMEOUT_SEC: int = 20
